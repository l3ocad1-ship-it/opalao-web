...
// NOTE: vitePluginStorageProxy() se removió a propósito.
// Ese proxy redirigía /manus-storage al backend interno de Manus (no disponible
// fuera de sus servidores). Ahora las imágenes viven localmente en
